...
if "__main__" == __name__:
    os.system("rm -rf /code/LBM/ai_001_001/hypersim/*")
    ...
    for split in ["train", "val", "test"]:
        ...
        split_meta_df = split_meta_df[split_meta_df["scene_name"] == "ai_001_001"]
        ...
        split_meta_df["normal_path"] = np.nan
        ...
        for i, row in tqdm(split_meta_df.iterrows(), total=len(split_meta_df)):
            ...
            print(dataset_dir, rgb_path)
            if not "ai_001_001" in str(rgb_path):
                continue
